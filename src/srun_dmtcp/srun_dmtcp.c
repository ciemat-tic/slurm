/*****************************************************************************\
 *  srun_dmtcp.c - Checkpoint/Restart wrapper for srun
 *****************************************************************************
...
/**************** copied and modified from cr_restart of DMTCP ****************/
...
create_listen_socket(void)
{
	...
	sprintf(cr_sock_addr, "/tmp/sock.srun_dmtcp.%u", (unsigned int)getpid());
