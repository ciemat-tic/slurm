...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/config.h.in $(top_srcdir)/slurm/slurm.h.in \
	$(srcdir)/config.xml.in \
	...
	$(top_srcdir)/etc/slurmdbd.service.in $(pkginclude_HEADERS) \
...
ACLOCAL = ${SHELL} /root/slurm/auxdir/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTHD_CFLAGS = 
AUTHD_LIBS = -lauth -le
AUTOCONF = ${SHELL} /root/slurm/auxdir/missing autoconf
AUTOHEADER = ${SHELL} /root/slurm/auxdir/missing autoheader
AUTOMAKE = ${SHELL} /root/slurm/auxdir/missing automake-1.14
AWK = gawk
BGL_LOADED = 
BGQ_LOADED = 
BG_INCLUDES = 
...
SLURMD_PORT = 
SLURM_API_AGE = 0
SLURM_API_CURRENT = 29
SLURM_API_MAJOR = 29
SLURM_API_REVISION = 0
SLURM_API_VERSION = 0x1d0000
SLURM_MAJOR = 15
SLURM_MICRO = 0
SLURM_MINOR = 08
SLURM_PREFIX = 
...
install_sh = ${SHELL} /root/slurm/auxdir/install-sh
